# Friend Book - Complete Code

# Code for Backend (Line 3)
# Code for Frontend (Line 513)
...
# Frontend - Although functions above which make buttons are also in front end work
...
Label(root, image=b, width='2000', height='115', bg='#45818e').pack()
# blue color hex code -> #405898

# Frames
F1= Frame(root,borderwidth=2, relief='sunken', bg='#45818e', bd='10') # Frame 1: left hand side for user to input and buttons displayed
F1.pack(side="left", expand=True, fill="both")
F2= Frame(root,borderwidth=2, relief="sunken", bg='#45818e', bd='20') # Frame 2: right hand side uses to display the output
...
#Entry 1: Name
Label(F1,text="Enter your Name:", bg='#45818e', bd='3', font=('calibri bold', 15), fg='white').grid(row=0, sticky=W,padx=10)#--> use to tell the use to input his name
E1= Entry(F1,bd=2)                    #--> create an Entry for user to write his name
E1.grid(row=0,column=1,padx=5,pady=12)

#Entry 2: Age
Label(F1,text="Enter your Age:", bg='#45818e', bd='3', font=('calibri bold', 15), fg='white').grid(row=1,sticky=W, padx=10)#--> use to tell the user to input his age
E2= Entry(F1,bd=2)      #--> create an Entry for user to write his age
E2.grid(row=1,column=1,padx=13,pady=12)

#Entry 3: Country
Label(F1,text="Enter your Country:", bg=('#45818e'), bd='3', font=('calibri bold', 15), fg='white').grid(row=2,sticky=W, padx=10)#--> use to tell the user to input his country
E3= Entry(F1,bd=2)        #--> create an Entry for user to write his country
E3.grid(row=2,column=1,padx=13,pady=12)

#Entry 4: Department
Label(F1,text="Enter your Feild:", bg='#45818e', bd='3', font=('calibri bold', 15), fg='white', anchor='center').grid(row=3,sticky=W, padx=10)#--> use to tell the user to input his department
E4= Entry(F1,bd=2)      #--> create an Entry for user to write his department
E4.grid(row=3,column=1,padx=13,pady=12)

#Entry 5: Hobbies
Label(F1,text="Enter your Hobbies:", bg='#45818e', bd='3', font=('calibri bold', 15), fg='white').grid(row=4,sticky=W, padx=10)#--> use to tell the user to input his hobbies
...
Label(F1, text="Enter your friend name's:", bg='#45818e', bd='3', font=('calibri bold', 15), fg='white').grid(row=40, sticky=W, padx=10)#--> use to tell the user to input his freind name
